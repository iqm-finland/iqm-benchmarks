...
def run(min_qubits=2, max_qubits=6, max_circuits=3, num_shots=100, backend_id='simulator', provider_backend=None):
    ...
    print("\nDiffuser =")
    print(diffusion_operator if diffusion_operator != None else "  ... too large!")
