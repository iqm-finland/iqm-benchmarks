...
from hamiltonian_simulation_exact import HamiltonianSimulation_Noiseless, HamiltonianSimulationExact
import hamlib_simulation_kernel
from hamlib_simulation_kernel import (  # would like to remove these
...
from hamlib_utils import construct_dataset_name, create_full_filenames
...
def analyze_and_print_result(
    ...
    # for method 2, use exact evolution of the Hamiltonian, starting with the initial state circuit
        ...
        correct_dist = HamiltonianSimulationExact(qc_initial, n_spins=num_qubits, hamiltonian_op=ham_op, time=1.0)
...
def run(
    ...
    if min_qubits % 2 == 1:
        min_qubits += 1  # min_qubits must be even (DEVNOTE: is this True?)
