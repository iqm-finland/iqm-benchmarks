...
def store_final_iter_to_metrics_json(
    ...
    '''
    unif_dict = {'unique_counts_unif': [], 'unique_sizes_unif': [], 'cumul_counts_unif': []}
...
def run(
    ...
    if method == 1:
        metrics.plot_metrics(f"Benchmark Results - MaxCut ({method}) - Ocean", options=dict(shots=num_shots))
...
def plot_results_from_data(
    ...
    **kwargs,
    ...
    metrics.plot_all_area_metrics(
        f"Benchmark Results - MaxCut ({method}) - Ocean",
