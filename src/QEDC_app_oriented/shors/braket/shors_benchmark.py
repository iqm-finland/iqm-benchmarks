...
sys.path[1:1] = [
    ...
    "../../_common/braket",
    "../../shors/_common",
    "../../quantum-fourier-transform/braket",
]
import execute as ex
import metrics as metrics
from qft_benchmark import inv_qft_gate, qft_gate
from shors_utils import generate_base, getAngle, getAngles, modinv
...
def run(min_qubits=3, max_circuits=1, max_qubits=18, num_shots=100, method=1, verbose=verbose, backend_id='simulator'):
