...
""" Local Imports """
from qfunctions import create_inverse_QFT, create_QFT
...
if __name__ == '__main__':
    ...
    print(
        'Please check source file to change input quantum state. By default is a maximal superposition state with |+> in every qubit.\n'
    )
