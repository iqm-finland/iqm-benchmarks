...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--algorithm", default="quantum-fourier-transform", help="Benchmarking algorithm to run.", type=str
    )
    ...
    parser.add_argument(
        "--method", default=1, help="Used for Bernstein-Vazirani, MaxCut, Monte-Carlo, QFT, Shor, and VQE", type=int
    )
